    ...
    return (
        <form className="flex flex-col gap-4" onSubmit={handleSubmit(handleShippingForm)}>
          <div className="flex flex-col gap-1">
            ...
            type="text" id="name" placeholder="Suhaib Shaikh" {...register("name")}/>
          ...
          <div className="flex flex-col gap-1">
            ...
            <input 
            className="border-b border-gray-200 py-2 outline-none text-sm"
            type="text" id="phone" placeholder="123456789" {...register("phone")}/>
          ...
          <div className="flex flex-col gap-1">
            ...
            <input 
            className="border-b border-gray-200 py-2 outline-none text-sm"
            type="text" id="address" placeholder="123 Main Street , Anytown" {...register("address")}/>
          ...
          <div className="flex flex-col gap-1">
            ...
            <input 
            className="border-b border-gray-200 py-2 outline-none text-sm"
            type="text" id="city" placeholder="New York" {...register("city")}/>
